...
Grabbing those credentials in the console is the only step here that needs a browser — every call below is plain HTTP you can run yourself or hand to an agent.
