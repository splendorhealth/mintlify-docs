...
- A Splendor API token and your tenant ID, both from the [console](https://app.withsplendor.com) under your workspace settings.
- A dataset with data in it. Brand-new workspace with nothing loaded yet? Start with [Add your data](/guides/ingest-a-dataset) — it takes a few minutes — then come back here.
...
<Steps>
  <Step title="List your datasets">
    ...
    const base = "https://api.withsplendor.com";
    const headers = {
